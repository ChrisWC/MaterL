...
var Icon = require('!raw!material-design-icons/navigation/svg/production/ic_menu_24px.svg');
...
class Component extends React.Component {
    ...
    getIcon = () => {
        var icon = null;
        try {
            icon = require('!raw!material-design-icons/' + this.props.context + '/svg/production/ic_'+this.props.component+'_24px.svg')//icons.svg[this.props.resolution]
        }
        catch (e) {
            console.log(e)
