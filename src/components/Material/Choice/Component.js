...
class Component extends React.Component {
    ...
    getIcon = (role, active) => {
        ...
        const star_filled =  (<Icon onClick={(e) => this.handleClick(e)} resolution={"24px"} context={"toggle"} component={"star_border"}/>)
        const star_empty =  (<Icon onClick={(e) => this.handleClick(e)} resolution={"24px"} context={"toggle"} component={"star"}/>)
    ...
    render() {
        return (
            <div style={this.state.style} onClick={this.props.onClick}>
                {this.state.active? this.getIcon(this.props.role, false):null}
                {!this.state.active? this.getIcon(this.props.role, true):null}
